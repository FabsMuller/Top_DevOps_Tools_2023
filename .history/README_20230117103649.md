...
First , the tools/services were divided into 10 categories, almost a decathlon!
 ...
 Inside each category, most fo time, five contenders, based on his personal choice, and one winner; with a draw allowed sometimes. I'll put a link to the tool and a link to the video where Victor reviews the tool (if exists), as it was in the video description. So, were are the nominees and the winners:
